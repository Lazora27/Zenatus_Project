...
STRATEGY_LISTING_BASE = Path("/opt/Zenatus_Dokumentation/Listing/Full_backtest")
...
GUI_DATA_PATH = BASE_PATH / "04_GUI" / "data"
...
# --- Tabs for Analysis ---
tab1, tab2 = st.tabs(["Current Results", "Run History"])
        ...
        for rid, info in history.items():
            if info.get("status") == "Running":
                ...
                if pid and not check_pid_running(pid):
                    ...
                    # Check exit code? Hard to get exit code of detached process without waiting.
                    # We can assume it finished.
