...
LISTING = {
    "WORKING": DOC / "Listing" / "indicators_working.json",
    "ERROR": DOC / "Listing" / "indicators_errors.json",
    "NO_RESULTS": DOC / "Listing" / "indicators_no_results.json",
    "WARNING": DOC / "Listing" / "indicators_warnings.json",
    "TIMEOUT": DOC / "Listing" / "indicators_timeout.json",
}
...
def main():
    ...
    if mode == "QUICKTEST":
        run_quicktest_validate_all(timeout_sec=600, limit=5, workers=4)
