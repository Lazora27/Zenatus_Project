...
QUICKTEST_JSON = BASE_PATH / "01_Backtest_System" / "Scripts" / "QUICKTEST_FAILED_1.json"
...
print("="*80)
print(f"QUICKTEST FAILED_1 - {TIMEFRAME.upper()}")
print("="*80)
print(f"Testing: 1 FAILED Indicator (#374)")
print("="*80)
...
LOG_FILE = LOG_PATH / f"quicktest_failed_1_{TIMEFRAME}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
