"""
DEEP-ANALYSE: Indikatoren 81-100
...
# MAIN
print("="*80)
print("DEEP-ANALYSE: INDIKATOREN 81-100")
print("="*80)
...
# Statistik
new_count = sum(1 for k in all_results.keys() if 81 <= int(k) <= 100)
compatible = sum(1 for k, r in all_results.items() if 81 <= int(k) <= 100 and r['backtest_compatible'])
avg_combos = sum(r['calculated_combinations'] for k, r in all_results.items() if 81 <= int(k) <= 100) / new_count if new_count > 0 else 0
