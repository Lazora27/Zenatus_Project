...
QUICKTEST_JSON = BASE_PATH / "01_Backtest_System" / "Scripts" / "QUICKTEST_ERROR_106.json"
...
print("="*80)
print(f"QUICKTEST ERROR_106 - {TIMEFRAME.upper()}")
print("="*80)
print(f"Testing: 106 ERROR_SIGNALS Indicators (Float->Int Fixed)")
print("="*80)
...
LOG_FILE = LOG_PATH / f"quicktest_error_106_{TIMEFRAME}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
