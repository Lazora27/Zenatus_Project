"""
DEEP-ANALYSE: Indikatoren 361-380
...
print("="*80)
print("DEEP-ANALYSE: INDIKATOREN 361-380")
print("="*80)
...
new_count = sum(1 for k in all_results.keys() if 361 <= int(k) <= 380)
avg = sum(r['calculated_combinations'] for k, r in all_results.items() if 361 <= int(k) <= 380) / new_count if new_count > 0 else 0
print(f"📊 (361-380): {new_count}/20, Ø {avg:.0f} Kombinationen")
print(f"📊 GESAMT (1-380): {len(all_results)} Indikatoren")
