...
QUICKTEST_JSON = BASE_PATH / "01_Backtest_System" / "Scripts" / "QUICKTEST_TIMEOUT_9.json"
...
print("="*80)
print(f"QUICKTEST TIMEOUT_9 - {TIMEFRAME.upper()}")
print("="*80)
print(f"Testing: 9 TIMEOUT_SIGNALS Indicators")
print("="*80)
...
LOG_FILE = LOG_PATH / f"quicktest_timeout_9_{TIMEFRAME}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
