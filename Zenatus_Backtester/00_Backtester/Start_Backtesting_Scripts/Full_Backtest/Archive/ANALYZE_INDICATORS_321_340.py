"""
DEEP-ANALYSE: Indikatoren 321-340
...
print("="*80)
print("DEEP-ANALYSE: INDIKATOREN 321-340")
print("="*80)
...
new_count = sum(1 for k in all_results.keys() if 321 <= int(k) <= 340)
avg = sum(r['calculated_combinations'] for k, r in all_results.items() if 321 <= int(k) <= 340) / new_count if new_count > 0 else 0
print(f"📊 (321-340): {new_count}/20, Ø {avg:.0f} Kombinationen")
print(f"📊 GESAMT (1-340): {len(all_results)} Indikatoren")
