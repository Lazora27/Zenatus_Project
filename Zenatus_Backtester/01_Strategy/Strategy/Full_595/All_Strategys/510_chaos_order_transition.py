"""
510_chaos_order_transition - Clean Wrapper
...
class Indicator_ChaosOrderTransition:
    """Clean wrapper for 510_chaos_order_transition"""
    
    def __init__(self):
        self.name = "510_chaos_order_transition"
