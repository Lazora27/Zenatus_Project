"""
033_trend_massindex - Clean Wrapper
...
class Indicator_MassIndex:
    """Clean wrapper for 033_trend_massindex"""
    
    def __init__(self):
        self.name = "033_trend_massindex"
    
    def calculate(self, data: pd.DataFrame, params: Dict) -> pd.Series:
        """Berechnet Mass Index."""
        ...
        # Mass Index
        mass_index = (ema1 / ema2).rolling(slow).sum()
