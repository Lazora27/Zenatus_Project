"""
461_order_flow_toxicity - Simple Fallback Wrapper
...
class Indicator_OrderFlowToxicity:
    """Simple fallback wrapper for 461_order_flow_toxicity"""
    
    def __init__(self):
        self.name = "461_order_flow_toxicity"
        self.period = 20
