"""
503_strange_attractor_detector - Clean Wrapper
...
class Indicator_StrangeAttractorDetector:
    """Clean wrapper for 503_strange_attractor_detector"""
    
    def __init__(self):
        self.name = "503_strange_attractor_detector"
