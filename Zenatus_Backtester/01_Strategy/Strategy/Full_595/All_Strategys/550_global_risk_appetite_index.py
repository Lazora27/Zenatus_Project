"""
550_global_risk_appetite_index - Clean Wrapper
...
class Indicator_GlobalRiskAppetiteIndex:
    """Clean wrapper for 550_global_risk_appetite_index"""
    
    def __init__(self):
        self.name = "550_global_risk_appetite_index"
