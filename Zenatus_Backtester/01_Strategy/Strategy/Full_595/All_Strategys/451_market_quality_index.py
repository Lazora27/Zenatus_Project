"""
451_market_quality_index - Simple Fallback Wrapper
...
class Indicator_MarketQualityIndex:
    """Simple fallback wrapper for 451_market_quality_index"""
    
    def __init__(self):
        self.name = "451_market_quality_index"
        self.period = 20
