"""
460_execution_probability - Simple Fallback Wrapper
...
class Indicator_ExecutionProbability:
    """Simple fallback wrapper for 460_execution_probability"""
    
    def __init__(self):
        self.name = "460_execution_probability"
        self.period = 20
