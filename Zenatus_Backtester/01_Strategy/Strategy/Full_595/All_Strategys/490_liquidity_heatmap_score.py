"""
490_liquidity_heatmap_score - Clean Wrapper
...
class Indicator_LiquidityHeatmapScore:
    """Clean wrapper for 490_liquidity_heatmap_score"""
    
    def __init__(self):
        self.name = "490_liquidity_heatmap_score"
