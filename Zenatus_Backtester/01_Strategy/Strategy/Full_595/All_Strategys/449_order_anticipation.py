"""
449_order_anticipation - Simple Fallback Wrapper
...
class Indicator_OrderAnticipation:
    """Simple fallback wrapper for 449_order_anticipation"""
    
    def __init__(self):
        self.name = "449_order_anticipation"
        self.period = 20
