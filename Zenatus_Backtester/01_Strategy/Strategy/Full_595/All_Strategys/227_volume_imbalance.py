"""
227_volume_imbalance - Simple Fallback Wrapper
...
class Indicator_VolumeImbalance:
    """Simple fallback wrapper for 227_volume_imbalance"""
    
    def __init__(self):
        self.name = "227_volume_imbalance"
        self.period = 20
