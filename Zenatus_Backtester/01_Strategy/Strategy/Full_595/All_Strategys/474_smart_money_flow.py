"""
474_smart_money_flow - Simple Fallback Wrapper
...
class Indicator_SmartMoneyFlow:
    """Simple fallback wrapper for 474_smart_money_flow"""
    
    def __init__(self):
        self.name = "474_smart_money_flow"
        self.period = 20
