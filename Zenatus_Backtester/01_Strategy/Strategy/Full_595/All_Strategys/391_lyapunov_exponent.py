"""
391_lyapunov_exponent - Simple Fallback Wrapper
...
class Indicator_LyapunovExponent:
    """Simple fallback wrapper for 391_lyapunov_exponent"""
    
    def __init__(self):
        self.name = "391_lyapunov_exponent"
        self.period = 20
