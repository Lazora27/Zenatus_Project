"""
168_volatility_coefficient_variation - Simple Fallback Wrapper
...
class Indicator_CoefficientOfVariation:
    """Simple fallback wrapper for 168_volatility_coefficient_variation"""
    
    def __init__(self):
        self.name = "168_volatility_coefficient_variation"
        self.period = 20
