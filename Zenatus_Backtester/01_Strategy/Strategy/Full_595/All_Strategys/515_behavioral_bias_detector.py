"""
515_behavioral_bias_detector - Clean Wrapper
...
class Indicator_BehavioralBiasDetector:
    """Clean wrapper for 515_behavioral_bias_detector"""
    
    def __init__(self):
        self.name = "515_behavioral_bias_detector"
