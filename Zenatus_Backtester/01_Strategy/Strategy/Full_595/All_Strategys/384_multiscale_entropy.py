"""
384_multiscale_entropy - Simple Fallback Wrapper
...
class Indicator_MultiscaleEntropy:
    """Simple fallback wrapper for 384_multiscale_entropy"""
    
    def __init__(self):
        self.name = "384_multiscale_entropy"
        self.period = 20
