"""
459_market_fragmentation - Simple Fallback Wrapper
...
class Indicator_MarketFragmentation:
    """Simple fallback wrapper for 459_market_fragmentation"""
    
    def __init__(self):
        self.name = "459_market_fragmentation"
        self.period = 20
