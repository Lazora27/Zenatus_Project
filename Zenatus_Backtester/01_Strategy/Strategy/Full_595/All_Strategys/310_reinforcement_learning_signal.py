"""
310_reinforcement_learning_signal - Simple Fallback Wrapper
...
class Indicator_ReinforcementLearningSignal:
    """Simple fallback wrapper for 310_reinforcement_learning_signal"""
    
    def __init__(self):
        self.name = "310_reinforcement_learning_signal"
        self.period = 20
