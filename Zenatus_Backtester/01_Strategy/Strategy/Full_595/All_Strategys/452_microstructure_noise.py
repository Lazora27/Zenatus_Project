"""
452_microstructure_noise - Simple Fallback Wrapper
...
class Indicator_MicrostructureNoise:
    """Simple fallback wrapper for 452_microstructure_noise"""
    
    def __init__(self):
        self.name = "452_microstructure_noise"
        self.period = 20
