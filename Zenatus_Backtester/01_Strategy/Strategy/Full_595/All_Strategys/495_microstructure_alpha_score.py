"""
495_microstructure_alpha_score - Clean Wrapper
...
class Indicator_MicrostructureAlphaScore:
    """Clean wrapper for 495_microstructure_alpha_score"""
    
    def __init__(self):
        self.name = "495_microstructure_alpha_score"
