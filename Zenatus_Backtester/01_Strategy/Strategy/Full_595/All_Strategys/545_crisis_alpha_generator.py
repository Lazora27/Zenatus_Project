"""
545_crisis_alpha_generator - Clean Wrapper
...
class Indicator_CrisisAlphaGenerator:
    """Clean wrapper for 545_crisis_alpha_generator"""
    
    def __init__(self):
        self.name = "545_crisis_alpha_generator"
