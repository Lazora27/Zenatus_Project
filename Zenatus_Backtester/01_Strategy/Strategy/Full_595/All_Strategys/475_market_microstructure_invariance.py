"""
475_market_microstructure_invariance - Simple Fallback Wrapper
...
class Indicator_MarketMicrostructureInvariance:
    """Simple fallback wrapper for 475_market_microstructure_invariance"""
    
    def __init__(self):
        self.name = "475_market_microstructure_invariance"
        self.period = 20
