"""
541_risk_parity_allocator - Clean Wrapper
...
class Indicator_RiskParityAllocator:
    """Clean wrapper for 541_risk_parity_allocator"""
    
    def __init__(self):
        self.name = "541_risk_parity_allocator"
