"""
385_compression_ratio - Simple Fallback Wrapper
...
class Indicator_CompressionRatio:
    """Simple fallback wrapper for 385_compression_ratio"""
    
    def __init__(self):
        self.name = "385_compression_ratio"
        self.period = 20
