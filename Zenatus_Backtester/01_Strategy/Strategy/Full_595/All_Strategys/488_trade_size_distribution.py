"""
488_trade_size_distribution - Clean Wrapper
...
class Indicator_TradeSizeDistribution:
    """Clean wrapper for 488_trade_size_distribution"""
    
    def __init__(self):
        self.name = "488_trade_size_distribution"
