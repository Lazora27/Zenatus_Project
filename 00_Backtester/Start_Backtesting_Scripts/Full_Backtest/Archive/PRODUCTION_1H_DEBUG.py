...
DATE_END = '2025-09-20'
# NUR Indikatoren 1-466 testen (aus 30 Prompts Analysis JSON)
# Skip 378-396: Produzieren nur VectorBT Timeouts, keine Ergebnisse (zu komplex)
SKIP_INDICATORS = [8] + list(range(378, 397)) + list(range(467, 601))
...
LEVERAGE = 10
POSITION_SIZE = 100
INDICATOR_TIMEOUT = 600  # 10 Minuten für Problem-Indikatoren
MAX_WORKERS = 1  # Sequentiell für Stabilität und besseres Debugging
...
print("="*80)
print(f"DEBUG BACKTEST - PROBLEM INDICATORS - {TIMEFRAME.upper()}")
print("="*80)
print("WARNUNG: Nur für Problem-Indikatoren verwenden!")
print("MAX_WORKERS=1 (sequentiell), erweiterte Logs")
print("="*80)
...
LOG_FILE = LOG_PATH / f"debug_{TIMEFRAME}_{datetime.now().strftime('%Y%m%d_%H%M%S')}.log"
