"""
DEEP-ANALYSE: Indikatoren 161-180
...
# MAIN
print("="*80)
print("DEEP-ANALYSE: INDIKATOREN 161-180")
print("="*80)
...
# Statistik
new_count = sum(1 for k in all_results.keys() if 161 <= int(k) <= 180)
compatible = sum(1 for k, r in all_results.items() if 161 <= int(k) <= 180 and r['backtest_compatible'])
avg_combos = sum(r['calculated_combinations'] for k, r in all_results.items() if 161 <= int(k) <= 180) / new_count if new_count > 0 else 0
