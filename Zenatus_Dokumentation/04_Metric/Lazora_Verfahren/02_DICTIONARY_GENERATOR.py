# -*- coding: utf-8 -*-
"""
DICTIONARY GENERATOR - INDICATOR ENCYCLOPEDIA
==============================================
Creates structured documentation for all 595 indicators
With Standard Values, Matrix Ranges, and Combinations
"""
...
OUTPUT_PATH = BASE_PATH / "10_Dictionary"
OUTPUT_PATH.mkdir(parents=True, exist_ok=True)

print("="*80)
print("DICTIONARY GENERATOR - INDICATOR ENCYCLOPEDIA")
print("="*80)
...
for entry in dictionary:
    row = {
        ...
        'Efficiency_Percent': entry['Matrix_Info']['Efficiency_Percent']
    }
...
for entry in dictionary[:10]:  # First 10 as example
...
print("="*80)
print(f"Total Indicators: {len(dictionary)}")
