"""
388_network_topology - Simple Fallback Wrapper
...
class Indicator_NetworkTopology:
    """Simple fallback wrapper for 388_network_topology"""
    
    def __init__(self):
        self.name = "388_network_topology"
        self.period = 20
