"""
382_lempel_ziv_complexity - Simple Fallback Wrapper
...
class Indicator_LempelZivComplexity:
    """Simple fallback wrapper for 382_lempel_ziv_complexity"""
    
    def __init__(self):
        self.name = "382_lempel_ziv_complexity"
        self.period = 20
