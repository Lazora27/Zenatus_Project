"""
392_attractor_dimension - Simple Fallback Wrapper
...
class Indicator_AttractorDimension:
    """Simple fallback wrapper for 392_attractor_dimension"""
    
    def __init__(self):
        self.name = "392_attractor_dimension"
        self.period = 20
