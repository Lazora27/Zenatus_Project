"""
440_algo_trading_detection - Simple Fallback Wrapper
...
class Indicator_AlgoTradingDetection:
    """Simple fallback wrapper for 440_algo_trading_detection"""
    
    def __init__(self):
        self.name = "440_algo_trading_detection"
        self.period = 20
