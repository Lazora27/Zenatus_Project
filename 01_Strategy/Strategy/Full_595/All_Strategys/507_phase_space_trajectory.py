"""
507_phase_space_trajectory - Clean Wrapper
...
class Indicator_PhaseSpaceTrajectory:
    """Clean wrapper for 507_phase_space_trajectory"""
    
    def __init__(self):
        self.name = "507_phase_space_trajectory"
