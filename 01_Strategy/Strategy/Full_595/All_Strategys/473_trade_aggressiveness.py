"""
473_trade_aggressiveness - Simple Fallback Wrapper
...
class Indicator_TradeAggressiveness:
    """Simple fallback wrapper for 473_trade_aggressiveness"""
    
    def __init__(self):
        self.name = "473_trade_aggressiveness"
        self.period = 20
