"""
472_optimal_execution_horizon - Simple Fallback Wrapper
...
class Indicator_OptimalExecutionHorizon:
    """Simple fallback wrapper for 472_optimal_execution_horizon"""
    
    def __init__(self):
        self.name = "472_optimal_execution_horizon"
        self.period = 20
