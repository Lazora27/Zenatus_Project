"""
505_nonlinear_dynamics_score - Clean Wrapper
...
class Indicator_NonlinearDynamicsScore:
    """Clean wrapper for 505_nonlinear_dynamics_score"""
    
    def __init__(self):
        self.name = "505_nonlinear_dynamics_score"
