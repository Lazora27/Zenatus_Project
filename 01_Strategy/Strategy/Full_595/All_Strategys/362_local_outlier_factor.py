"""
362_local_outlier_factor - Simple Fallback Wrapper
...
class Indicator_LocalOutlierFactor:
    """Simple fallback wrapper for 362_local_outlier_factor"""
    
    def __init__(self):
        self.name = "362_local_outlier_factor"
        self.period = 20
