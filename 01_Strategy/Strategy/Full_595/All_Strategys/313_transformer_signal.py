"""
313_transformer_signal - Simple Fallback Wrapper
...
class Indicator_TransformerSignal:
    """Simple fallback wrapper for 313_transformer_signal"""
    
    def __init__(self):
        self.name = "313_transformer_signal"
        self.period = 20
