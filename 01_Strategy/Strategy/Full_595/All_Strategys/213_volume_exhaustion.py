"""
213_volume_exhaustion - Simple Fallback Wrapper
...
class Indicator_VolumeExhaustion:
    """Simple fallback wrapper for 213_volume_exhaustion"""
    
    def __init__(self):
        self.name = "213_volume_exhaustion"
        self.period = 20
