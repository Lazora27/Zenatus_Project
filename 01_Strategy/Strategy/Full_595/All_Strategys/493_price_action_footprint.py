"""
493_price_action_footprint - Clean Wrapper
...
class Indicator_PriceActionFootprint:
    """Clean wrapper for 493_price_action_footprint"""
    
    def __init__(self):
        self.name = "493_price_action_footprint"
