"""
464_liquidity_provision_score - Simple Fallback Wrapper
...
class Indicator_LiquidityProvisionScore:
    """Simple fallback wrapper for 464_liquidity_provision_score"""
    
    def __init__(self):
        self.name = "464_liquidity_provision_score"
        self.period = 20
