"""
351_prophet_forecast - Simple Fallback Wrapper
...
class Indicator_ProphetForecast:
    """Simple fallback wrapper for 351_prophet_forecast"""
    
    def __init__(self):
        self.name = "351_prophet_forecast"
        self.period = 20
