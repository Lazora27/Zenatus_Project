"""
518_wave_function_collapse - Clean Wrapper
...
class Indicator_WaveFunctionCollapse:
    """Clean wrapper for 518_wave_function_collapse"""
    
    def __init__(self):
        self.name = "518_wave_function_collapse"
