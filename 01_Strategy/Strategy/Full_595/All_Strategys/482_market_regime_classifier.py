"""
482_market_regime_classifier - Clean Wrapper
...
class Indicator_MarketRegimeClassifier:
    """Clean wrapper for 482_market_regime_classifier"""
    
    def __init__(self):
        self.name = "482_market_regime_classifier"
