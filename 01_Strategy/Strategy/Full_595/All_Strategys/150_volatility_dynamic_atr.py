"""
150_volatility_dynamic_atr - Simple Fallback Wrapper
...
class Indicator_DynamicATR:
    """Simple fallback wrapper for 150_volatility_dynamic_atr"""
    
    def __init__(self):
        self.name = "150_volatility_dynamic_atr"
        self.period = 20
