"""
235_average_trade_size - Simple Fallback Wrapper
...
class Indicator_AverageTradeSize:
    """Simple fallback wrapper for 235_average_trade_size"""
    
    def __init__(self):
        self.name = "235_average_trade_size"
        self.period = 20
