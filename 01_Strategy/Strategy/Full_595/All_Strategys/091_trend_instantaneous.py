"""
091_trend_instantaneous - Simple Fallback Wrapper
...
class Indicator_Instantaneous:
    """Simple fallback wrapper for 091_trend_instantaneous"""
    
    def __init__(self):
        self.name = "091_trend_instantaneous"
        self.period = 20
