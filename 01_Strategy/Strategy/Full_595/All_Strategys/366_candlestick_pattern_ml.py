"""
366_candlestick_pattern_ml - Simple Fallback Wrapper
...
class Indicator_CandlestickPatternML:
    """Simple fallback wrapper for 366_candlestick_pattern_ml"""
    
    def __init__(self):
        self.name = "366_candlestick_pattern_ml"
        self.period = 20
